...
export function AppShell({ children }: AppShellProps) {
  return (
    <div className="grid min-h-dvh grid-rows-[auto_minmax(0,1fr)_auto] lg:grid-cols-[15rem_minmax(0,1fr)] lg:grid-rows-[auto_minmax(0,1fr)_auto]">
      <a
      ...
      <main
        id="main-content"
        className="mx-auto w-full max-w-6xl px-4 pt-6 pb-24 lg:col-start-2 lg:row-[1/-1] lg:max-w-none lg:p-8"
        tabIndex={-1}
      >
        {children}
      </main>
