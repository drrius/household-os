...
// Base UI menu items emit wrapped synthetic events rather than DOM Events.
...
// Base UI puts hover delays on the trigger, not the root; upstream wants
// the card to open and close instantly.
