...
-- Exercise the same restricted repair command used by the data migration.
...
select throws_ok($$select private.repair_missing_grocery_fallbacks()$$,'42501',null,'members cannot invoke the migration repair command');
